...
local msg = MusicianEZK.InitLocale("zh", "中文", "zhCN")

------------------------------------------------------------------------
---------------- ↑↑↑ DO NOT EDIT THE LINES ABOVE ! ↑↑↑  ----------------
------------------------------------------------------------------------

msg.MENU_EASY_KEYBOARD = "启动EZ键盘"
msg.COMMAND_LIVE_KEYBOARD = "启动EZ键盘"
msg.EASY_KEYBOARD_TITLE = "EZ键盘"
msg.SELECT_INSTRUMENT = "选择乐器"
msg.HEADER_OCTAVE = "八度移调"

msg.ERROR_MUSICIAN_VERSION_TOO_OLD = "你的Musician版本太旧以致不能使用Musician EZK，请升级。"
msg.ERROR_MUSICIAN_EZK_VERSION_TOO_OLD = "您的 Musician EZK 版本太旧。 请更新它。"