...
local msg = MusicianEZK.InitLocale("ko", "한국어", "koKR")

------------------------------------------------------------------------
---------------- ↑↑↑ DO NOT EDIT THE LINES ABOVE ! ↑↑↑  ----------------
------------------------------------------------------------------------

msg.MENU_EASY_KEYBOARD = "EZ 키보드 열기"
msg.COMMAND_LIVE_KEYBOARD = "EZ 키보드 열기"
msg.EASY_KEYBOARD_TITLE = "EZ 키보드"
msg.SELECT_INSTRUMENT = "악기 선택"
msg.HEADER_OCTAVE = "옥타브"

msg.ERROR_MUSICIAN_VERSION_TOO_OLD = "Musician 버전이 Musician EZK에 비해 너무 오래되었습니다. 업데이트하십시오."
msg.ERROR_MUSICIAN_EZK_VERSION_TOO_OLD = "Musician EZK 버전이 너무 오래되었습니다. 업데이트하십시오."