...
local msg = MusicianEZK.InitLocale("tw", "繁體中文", "zhTW")

------------------------------------------------------------------------
---------------- ↑↑↑ DO NOT EDIT THE LINES ABOVE ! ↑↑↑  ----------------
------------------------------------------------------------------------

msg.MENU_EASY_KEYBOARD = "啟動EZ鍵盤"
msg.COMMAND_LIVE_KEYBOARD = "啟動EZ鍵盤"
msg.EASY_KEYBOARD_TITLE = "EZ鍵盤"
msg.SELECT_INSTRUMENT = "選擇樂器"
msg.HEADER_OCTAVE = "八度移調"

msg.ERROR_MUSICIAN_VERSION_TOO_OLD = "你的Musician版本太舊以致不能使用Musician EZK，請升級。"
msg.ERROR_MUSICIAN_EZK_VERSION_TOO_OLD = "您的 Musician EZK 版本太舊。 請更新它。"